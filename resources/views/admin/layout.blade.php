...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('admin/asset/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('brand/all')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('about/all')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                About
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('service/all')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Service
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('slider/all')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                slider
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{url('contact/all')}}" class="nav-link">
                      <i class="nav-icon fas fa-th"></i>
                      <p>
                        contact data
                      </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{url('portfolio/all')}}" class="nav-link">
                      <i class="nav-icon fas fa-th"></i>
                      <p>
                        portfolio
                      </p>
                  ...
                  <li class="nav-item">
                    <a href="{{url('portfolioImage/all')}}" class="nav-link">
                      <i class="nav-icon fas fa-th"></i>
                      <p>
                        portfolio image
                      </p>
...
<script src="{{asset('admin/asset/js/pages/dashboard.js')}}"></script>
